...
class _HomePageState extends State<HomePage> {
  ...
  void didChangeDependencies() {
    categoryItemList =
        Provider.of<LibraryProvider>(context, listen: false).categoryItemList;
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              //         onPressed: () {
              //           Navigator.pushNamed(
              //               context, AllBookCategoryPage.routeName);
              //         },
              //         child: Text("View All>>"))
              //   ],
              // ),
          ...
          //                 menuIcon: categoryItemList![index].image,
          //                 menuTitle: categoryItemList![index].name,
          //               )),
          //     ),
            Text(
            "Explore your books",
              ...
              Container(
                ...
                child: Consumer<LibraryProvider>(
                  builder: (context, provider, _) => ListView.builder(
                    ...
                    itemCount: provider.cseBooksList.length,
                      itemBuilder: (context, index) => BookItem(bookItem: provider.cseBooksList[index],bookList: provider.cseBooksList,)),
                ),
              )
            ],
          ),
